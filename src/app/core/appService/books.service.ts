...
export class BooksService {
  ...
  data = [
    ...
    },
    {
      ...
      Quantity: 3,
      Summary:
        "'“It Starts With Us” instead focuses on recovery and starting a new life of healthy love. It's a story about feeling loved for the first time and giving the love you believe others deserve from you. This book explains that not all parental love is unconditional and not all romantic love will end.'",
    },
    {
      id: 8,
